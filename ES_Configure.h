...
#define EVENT_CHECK_HEADER "TrackEventChecker.h"

/****************************************************************************/
// This is the list of event checking functions
#define EVENT_CHECK_LIST  TrackEvent
...
#define TIMER9_RESP_FUNC PostBeaconService
...
#define STEP_TIMER 0 /*make sure this is enabled above and posting to the correct state machine*/
#define BUMPER_SERVICE_TIMER 1
#define TAPE_SENSOR_SERVICE_TIMER 2
#define TURN_OFF_TAPE_TIMER 3
#define BACK_UP_TIMER 4
#define LOAD_TIMER 5
#define FORWARD_TIMER 6
#define BEACON_SPIN_TIMER 7
#define LOAD_SPIN_TIMER 8
#define BEACON_SERVICE_TIMER 9
#define TAPE_BACKUP_TIMER 10
#define BALL_TIMER 11
#define BOUNCE_OFF_TIMER 12
#define BUMP_TURN_TIMER 13
...
#if NUM_SERVICES > 2
// the header file with the public fuction prototypes
#define SERV_2_HEADER "HSM.h"
// the name of the Init function
#define SERV_2_INIT InitHSM
// the name of the run function
#define SERV_2_RUN RunHSM
// How big should this services Queue be?
