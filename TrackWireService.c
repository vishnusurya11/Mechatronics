...
ES_Event RunTrackService(ES_Event ThisEvent) {
     ...
     *******************************************/
    unsigned char currentTracks = CheckTracks(); // read all bumpers
    static uint8_t trackMem = 0x00;
            ...
            switch (trackMem) {
                ...
                case 0x33:
                    ...
                    if (curEvent != lastEvent) {
                        //printf("**********************************track-Event**************\n");
                        ReturnEvent.EventType = TRACK;
                        ReturnEvent.EventParam = currentTracks;
#ifndef SIMPLESERVICE_TEST           // keep this as is for test harness
                        PostHSM(ReturnEvent);
#else
                        PostTrackService(ReturnEvent);
#endif  
                    }
                    lastEvent = TRACK;
                    break;
