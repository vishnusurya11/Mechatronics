...
static FindingTarget2SubHSMState_t CurrentState = DrivingForward; // <- change name to match ENUM
...
/**
 * @Function InitFindingTarget2SubHSM(uint8_t Priority)
...
uint8_t InitFindingTarget2SubHSM(void) {
    ...
    returnEvent = RunFindingTarget2SubHSM(INIT_EVENT);
...
/**
 * @Function RunFindingTarget2SubHSM(ES_Event ThisEvent)
...
ES_Event RunFindingTarget2SubHSM(ES_Event ThisEvent) {
    uint8_t makeTransition = FALSE; // use to flag transition
    FindingTarget2SubHSMState_t nextState; // <- change type to correct enum
    ES_Tattle(); // trace call stack
    static FindingTarget2SubHSMState_t lastState;
    ...
    if (makeTransition == TRUE) { // making a state transition, send EXIT and ENTRY
        ...
        RunFindingTarget2SubHSM(EXIT_EVENT); // <- rename to your own Run function
        CurrentState = nextState;
        //printf("\n nextstate=%d \n", CurrentState);
        RunFindingTarget2SubHSM(ENTRY_EVENT); // <- rename to your own Run function
    }
